...
<body>
   ...
   <div class="box">
      ...
      <a style="color:rgb(255, 187, 0);" href="users_detail.php?update_user=<?php echo $fetch_user['Id']; ?>">Chỉnh sửa</a>
      <a href="users_detail.php?delete_user=<?php echo $fetch_user['Id']; ?>" onclick="return confirm('Bạn có muốn xóa người dùng này');">Xóa</a>
   </div>
   <?php
      }
   }else{
        ...
        <div class="edit-product-form">
            ...
            ?>
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" value="<?php echo $fetch_update['name'] ?>" name="update_name" placeholder="Nhập tên" required class="box ">
                            <input type="text" value="<?php echo $fetch_update['surname'] ?>" name="update_sname" placeholder="Nhập họ" required class="box">
                            <input type="email" value="<?php echo $fetch_update['email'] ?>" name="update_email" placeholder="Nhập Email" required class="box">
                            <input type="password" value="<?php echo $fetch_update['password'] ?>" name="update_password" placeholder="Nhập Mật khẩu" required class="box">
