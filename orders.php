...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Id đơn đặt hàng : <span># <?php echo $fetch_book['order_id']; ?> </p>
         ...
         <p> Tổng tiền : <span><?php echo $fetch_book['total_price']; ?> đ</span> </p>
         <p> Trạng thái thanh toán : <span style="color:<?php if($fetch_book['payment_status'] == 'Chưa xử lí'){ echo 'red'; }else{ echo 'green'; } ?>;"><?php echo $fetch_book['payment_status']; ?></span> </p>
