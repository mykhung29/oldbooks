...
<html lang="en">
  <head>
    ...
    <title>OldBook Store Admin</title>
  </head>
  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Đơn đặt hàng đang chờ xử lý</h5>
          <p class="card-text"> 
          <?php echo $total_pendings ?>
          </p>
          <div class="buttons" style="display: flex;">
          <a href="admin_orders.php" class="btn btn-primary">Chi Tiết</a>
          </div>
        </div>
      </div>
      <div class="card" style="width: 15rem">
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Số đơn hàng đã hoàn thành</h5>
          <p class="card-text">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số đơn hàng đã nhận</h5>
          <p class="card-text">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số sách có sẵn trên kệ</h5>
          <p class="card-text">
          <?php echo $bookscount; ?>
          </p>
          <div class="buttons" style="display: flex;">
          <a href="total_books.php" class="btn btn-primary">Xem Sách</a>
          <a href="add_books.php" class="btn btn-primary">Thêm Sách</a>
          </div>
        </div>
      </div>
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Các tin nhắn từ khách hàng</h5>
          <p class="card-text">
          <?php echo $msgcount; ?>
          </p>
          <a href="message_admin.php" class="btn btn-primary">Chi Tiết</a>
        </div>
      </div>
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/adminpn2.png" alt="Card image cap" />
        <div class="card-body">
          <h5 class="card-title">Số lượng quản trị viên đã đăng ký</h5>
          <p class="card-text">
            <?php echo $admin_count; ?>
          </p>
          <a href="users_detail.php" class="btn btn-primary">Chi Tiết</a>
        </div>
      </div>
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/userspm.png" alt="Card image cap" />
        <div class="card-body">
          <h5 class="card-title">Số lượng tài khoản đã đăng ký</h5>
          <p class="card-text">
            <?php echo $usercount; ?>
          </p>
          <a href="users_detail.php" class="btn btn-primary">Chi Tiết</a>
