                    ...
                    <div class="row_box">
                        <form style="display: flex ;" action="" method="POST">
                            ...
                            <div class="col_box">
                                ...
                                <h1>Tên: <?php echo $fetch_book['name']; ?></h1>
                                <h3>Giá: <?php echo $fetch_book['price']; ?>.</h3>
                                <label for="quantity">Số lượng:</label>
                                <input type="number" name="quantity" value="1" min="1" max="20" id="quantity">
                                <div class="buttons">
                                    ...
                                    <input type="submit" name="add_to_cart" value="Thêm" class="btn">
                                    <!-- <input type="submit" name="add_to_cart" value="Add to cart" class="btn"> -->
                                    <button name="add_to_cart" ><img style="height: 35px;" src="./images/cart1.png" alt="Thêm"></button>
                                </div>
                                <h3>Mô tả quyển sách:</h3>
