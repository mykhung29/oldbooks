...
if (isset($_POST['add_to_cart'])) {
    if (!isset($user_id)) {
        $message[] = 'Vui lòng đăng nhập để tiếp tục mua sách!';
    } else {
...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 " src="https://source.unsplash.com/2200x800/?harry potter" alt="First slide">
            </div>

            <div class="carousel-item">
                <img class="d-block w-100" src="https://source.unsplash.com/2200x800/?the hobbits" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="https://source.unsplash.com/2200x800/?narnia" alt="Third slide">
            </div>
        </div>
    ...
    <section id="New">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="m-8 font-extrabold text-4xl text-center border-t-2 " style="font-family: 'Comic Sans MS'; color: rgb(255, 0, 0);">
                Mới Cập Nhật
            </h2>
        </div>
    </section>
    ...
    <section id="Adventure">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="text-gray-400 m-8 font-extrabold text-4xl text-center border-t-2 text-red-800" style="font-family: 'Comic Sans MS'; color: rgb(0, 167, 245);" >
                Adventure
            </h2>
        </div>
    </section>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` Where category='medieval'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Romance'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Detective'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='SelfHelp'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Sciene'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
