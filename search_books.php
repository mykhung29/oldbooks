...
<body>
   ...
   <section class="search-form">
      ...
      <form action="" method="POST">
         <input type="text" class="box" name="search_box" placeholder="Nhập tên quyển sách bạn cần tìm...">
   ...
   <div class="msg">
      ...
      if (isset($_POST['search_btn'])) {
         ...
         echo '<h4>Kết quả tìm kiếm cho "'. $search_box.'"là:</h4>';
      };
      ?>
   </div>
         ...
         ?>
                  ...
                  <div class="box" style="width: 255px;height: 342px;">
                     ...
                     <div style="text-align:left ;">
                        ...
                        <div style="font-weight: 500; font-size:18px; " class="name">Tên: <?php echo $fetch_book['name']; ?></div>
                     </div>
                     ...
                     <form action="" method="POST">
                        ...
                        <button onclick="myFunction()" name="add_to_cart"><img src="./images/cart2.png" alt="Add to cart">
                           <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                                               echo '-name=', $fetch_book['name']; ?>" id="adventure" class="update_btn">Chi tiết</a>
                     </form>
                  </div>
         <?php
               }
            } else {
               echo '<p class="empty">Không tìm thấy "'. $search_box.'"! </p>';
            }
         };
         ?>
      </div>
