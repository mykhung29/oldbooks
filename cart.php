...
<body>
    ...
    ?>
        <table style="width: 70%; align-items:center; margin:10px auto;" >
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="POST">
                                    <input type="number" name="update_quantity" min="1" max="20" value="<?php echo $row['quantity']; ?>">
                                ...
                                <a style="color: red;" href="cart.php?remove=<?php echo $row['id'];?>"> Xóa</a>
                                </form>
                           
                            
                        </td>
                            <td><?php $sub_total=$row['price']*$row['quantity']; echo $subtotal=number_format($row['price']*$row['quantity']); ?>.000</td>
                            </tr>
                ...
                $total += $sub_total;
                    ...
                    echo '<p class="empty">Không có thứ gì trong giỏ hàng!</p>';
                }
                ?>
                <tr>
                    <th style="text-align:center;" colspan="3">Tổng</th>
        ...
        <a href="checkout.php" class="btn cart-btn1" style="display:<?php if($total>1){ echo 'inline-block'; }else{ echo 'none'; };?>" > &nbsp; Tiến hành kiểm tra</a> <a class="cart-btn2" href="index.php">Tiếp tục mua sắm</a>
    </div>
