...
<body>
  ...
  ?>
    <a class="update_btn" style="position: fixed ; z-index:100;" href="add_books.php">Thêm Sách Mới</a>
   ...
   ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
               $select_book = mysqli_query($conn, "SELECT * FROM `book_info` ORDER BY price desc") or die('query failed');
      ...
      ?>
            <div class="box">
                ...
                <a href="total_books.php?update=<?php echo $fetch_book['bid']; ?>" class="update_btn">Chỉnh sửa</a>
