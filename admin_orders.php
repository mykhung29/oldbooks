         ...
         ?>
               <div class="box">
                  ...
                  <form action="" method="post">
                     ...
                     <a class="cart-btn1" href="admin_orders.php?delete=<?php echo $fetch_book['order_id']; ?>" onclick="return confirm('Xóa đơn này?');">Xóa</a>
                  </form>
               </div>
         <?php
            }
